...
//	});
	...
	//$("#usernemeaa").click(function(){
    //$(this).siblings('.ShortcutBtn').slideToggle(100);
    //$(this).toggleClass('selected');
    //});
	...
	$(".timeline-comment .timeline-box-title textarea").click(function(){
		 ...
		 $(this).parents('.ui-textarea').next().show( );
			...
			$(this).parent().removeClass("HoldUp");
			$(this).parents('.ui-textarea').next().hide( );
			})
	...
	$(".SaidTwo-box-title .Said-textarea textarea").click(function(){
		 ...
		 $(this).parents('.Said-textarea').next().show( );
			...
			$(this).parent().removeClass("HoldUp2");
			$(this).parents('.Said-textarea').next().hide( );
			})
	
	//私信回复那块的
	$("#reply").click(function(){
		$(".private-comment").slideToggle(100);
		var $shizhongyin =$(".lines");
		if($shizhongyin.css("display")=="block"){
		  $shizhongyin.hide("fast");
		}
	});	
	
	$("#viewBtn").click(function(){
		$(".lines").slideToggle(100);
	...
	//$(".private-comment .private-box-title textarea").click(function(){
//		 $(this).parent().addClass('HoldUp');
//		 $(this).parents('.ui-textarea').next().show( );
//		}).blur(function(){
//			$(this).parent().removeClass("HoldUp");
...
//			})
  ...
  $("#article").click(function(){
		$(".private-comment").slideToggle(100);
		var $shizhongyin = $(".lines");
		if($shizhongyin.css("display")=="none"){
			$shizhongyin.show("fast");
			}
...
//	      $("table.restaurantList tbody tr")
//					.hide()
//					.filter(":contains('"+( $(".select_box input").val() )+"')")
//					.show();
//	   })
